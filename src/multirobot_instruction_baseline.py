...
# from ddpg import *
from instruction_mddpg.magent import *
...
def main():
    ...
    if is_training:
        ...
        while True:
            ...
            scores = np.zeros(2) 
            while True:
                a = agent.act(states, instruction_idxs)
                ...
                state_s, instruction_s, r, dones, arrives = env.step([a[0], a[1]], [past_action[0], past_action[1]])

                agent.update(states, instruction_idxs, a, r, state_s, instruction_idxs, dones)
